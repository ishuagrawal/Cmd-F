...
export const semanticPassage =
  'h1,h2,h3,h4,h5,h6,p,li,pre,table,dt,dd,blockquote,figcaption,caption,address,label,legend,output,dialog,[role="heading"],[role="paragraph"],[role="status"],[role="alert"],[role="log"],[data-testid="tweetText"]';
